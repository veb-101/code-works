...
for i = 1:m
  Xset = X(1:i,:);
  yset = y(1:i);
  % theta on this training set
  theta = trainLinearReg(Xset, yset, lambda);
  
  % calculating training set error with the theta calculated over the training set
  % training set error only consist of subsets of training set Xset,Yset
